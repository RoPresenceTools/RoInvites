...
class LeaderboardCog(commands.Cog):
    ...
    async def get_all_paginated(
        ...
        view = PaginatedLeaderboard(
            ...
            total_func=self.bot.leaderboard_manager.get_total_total_playtimes,
    ...
    async def get_all_ls_paginated(
        ...
        view = PaginatedLeaderboard(
            ...
            total_func=self.bot.leaderboard_manager.get_total_ls_total_playtimes,
            pagin_func_args=[interaction.guild],
            entries=entries,
    ...
    async def get_all_game_paginated(
        ...
        view = PaginatedLeaderboard(
            ...
            total_func=self.bot.leaderboard_manager.get_total_agg_game_playtimes,
            pagin_func_args=[interaction.guild],
            entries=entries,
            title="All-Time Playtime Leaderboard",
            user_id=None,
    ...
    async def get_all_ls_game_paginated(
        ...
        view = PaginatedLeaderboard(
            ...
            total_func=self.bot.leaderboard_manager.get_total_agg_ls_game_playtimes,
            pagin_func_args=[interaction.guild],
            entries=entries,
            title="Since-Last-Snapshot Playtime Leaderboard",
            user_id=None,
    ...
    async def get_user_paginated(
        ...
        view = PaginatedLeaderboard(
            ...
            total_func=self.bot.leaderboard_manager.get_total_game_playtimes,
    ...
    async def get_user_paginated(
        ...
        view = PaginatedLeaderboard(
            ...
            total_func=self.bot.leaderboard_manager.get_total_ls_game_playtimes,
            pagin_func_args=[interaction.guild, user_id],
            entries=entries,
    ...
    async def all_time_game_leaderboard(
        ...
        view = PaginatedLeaderboard(
            ...
            total_func=self.bot.leaderboard_manager.get_total_game_playtimes_breakdown,
    ...
    async def ls_game_leaderboard(
        ...
        view = PaginatedLeaderboard(
            ...
            total_func=self.bot.leaderboard_manager.get_total_ls_game_playtimes_breakdown,
            pagin_func_args=[interaction.guild, place_id],
            entries=entries,
